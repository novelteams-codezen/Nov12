...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Nov12", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Nov12Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Nov12 API v1");
